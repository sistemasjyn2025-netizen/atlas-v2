      ...
      try {
        ...
        const projectFile = {
          ...
          building: {
            ...
            length: data.length,
            height: data.height,
            baySpacing: data.frameSpacing || 5000,
            roofType: data.roofType === 'un-agua' ? 'mono-pitch' : 'gable',
            roofSlope: data.roofPitch ? data.roofPitch / 100 : 0.15,
            structuralProfile: data.mainProfileId,
            structureType: data.structureType || 'alma-llena',
            purlinSpacing: data.purlinSpacing || 1000,
            frontGates: 2,
            rearGates: 2,
            sideGates: 1
          }
