...
export class BoxSection extends StructuralSection {
  constructor(
    id: string,
    code: string,
    name: string,
    ...
    super(id, code, name, SectionShape.Box, family, method, metadata);
  }
  ...
  protected compareDimensions(other: StructuralSection): boolean {
    if (!(other instanceof BoxSection)) return false;
